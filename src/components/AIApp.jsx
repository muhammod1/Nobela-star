  ...
  return (
    <div className="bg-blue" id="ai_app">
      <div className="flex flex-col justify-between  laptop_l:flex-row text-white w-[100%] h-fit mx-auto max-w-[1530px]">
        <div className="flex mx-auto flex-col px- py-6  w-full laptop_l:w-[50%] border-b-white border-b-6 border-r-0 laptop_l:border-r-white border-l-0 border-t-0 laptop_l:border-b-0 border-4">
          ...
          <div className="flex justify-between laptop:gap-16 laptop_l:gap-8 mt-1 tablet:mt-6 w-full">
            <Link to="/image" className="flex flex-col">
              <img
                className="hover:scale-105 w-[80%] mx-auto laptop:w-[350px]  h-[170px]"
                src={picR}
                alt="pic"
              />
        ...
        <div className="flex flex-col px-4  tablet:py-12 w-full laptop_l:w-[50%] border-l-0  laptop_l:border-l-white border-r-0 border-t-0 border-b-0 border-4">
          <div className="flex justify-center w-fit mx-auto laptop_l:w-full items-center gap-4 my-auto ">
            ...
            >
              <img
                className=" hover:scale-105 tablet_l:w-[400px] tablet_l:h-[400px] w-[150px] h-[150px] my-5"
                src={chatgbt}
                alt="chatgbt"
              />
