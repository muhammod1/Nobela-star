  ...
  return (
    <div className="bg-blue">
      <div className="flex flex-col laptop_l:flex-row text-white w-[97%] h-fit mx-auto max-w-[1430px]">
        <div className="flex w-fit mx-auto flex-col px-4 py-12  w-[90%] laptop_l:w-[50%] border-b-white border-b-6 border-r-0 laptop_l:border-r-white border-l-0 border-t-0 laptop_l:border-b-0 border-4">
        ...
        <div className="flex flex-col px-4 py-2 tablet:py-12 w-full laptop_l:w-[50%] border-l-0  laptop_l:border-l-white border-r-0 border-t-0 border-b-0 border-4">
          <div className="flex items-center gap-4 m-auto ">
            ...
            <a href="https://chat.openai.com/" className="flex mx-auto flex-col">
