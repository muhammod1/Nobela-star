    ...
    <div className="bg-blue">
      <div className="flex flex-col laptop_l:flex-row text-white w-[97%] h-fit mx-auto max-w-[1430px]">
        <div className="flex w-fit mx-auto flex-col px-4 py-12  w-full laptop_l:w-[50%] border-b-white border-b-6 border-r-0 laptop_l:border-r-white border-l-0 border-t-0 laptop_l:border-b-0 border-4">
          ...
          <p className="font-[500] mx-auto mt-2 mb-5 text-[20px] w-[95%] tablet:w-[350px] text-center ">
            We have created some AI software for you to checkout
          </p>
          <div className="flex  laptop:gap-16 laptop_l:gap-8 mt-6 w-fit mx-auto">
            <Link to="/image" className="flex laptop_l:mx-auto flex-col">
              <img className="w-[80%] mx-auto laptop:w-[180px]  h-[180px]" src={picR} alt="pic" />
              <p className="text-center text-[14px] laptop:text-[16px] font-[500] -mt-4 tablet:mt-3">
            ...
            <Link to="/speechRec" className="flex flex-col tablet:flex-col-reverse laptop_l:mx-auto">
              ...
              <p className="text-center text-[14px] laptop:text-[16px] font-[500] -mt-4 tablet:mt-0 mb-3">
              Voice to text AI
              </p>
            </Link>
          </div>
