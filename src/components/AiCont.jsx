...
const note = [
  {
    ...
    desc2: "Artificial intelligence (AI) is a field of computer science that focuses on the creat..."
  },
  {
    id: 2,
    ...
    desc2: "Some of the many applications of AI in various industries, such as healthcare, finance, transportation,..."
  },
  {
    id: 3,
    title: "Benefit of AI",
    ...
    desc2: "There are many benefits of AI, such as increased efficiency, improved decision-making, enhanced..."
  },
  {
    id: 4,
    ...
    desc2: "There challenges and risks associated with AI, such as job displacement, bias, lack of empath..."
  },
  {
    id: 5,
    title: "Future of AI",
    ...
    desc2: "Some of the emerging trends and developments in AI, such as the growth of AI-powered voice..."
  },
  {
    id: 6,
    ...
    desc2: "Some of the many opportunities for further research and development in AI, such as improving the..."
  },
];
const AiCont = () => {
  return (
    ...
    <img className="hidden tablet_l:block absolute bottom-0 right-0 h-full" src={AiCon} alt="ai"/>
      <div className="py-5">
        ...
        <div className="flex flex-wrap gap-5 justify-center tablet_l:justify-between">
            {note.map((item) => (
                <div key={item.id} className="flex tablet:block w-[95%] tablet_l:w-[45%] pb-3 tablet:pb-5 border-[3px] tablet:border-0 border-b-blue border-l-0 border-t-0 border-r-0">
                  <div className="">
                    <p className="font-[600] text-[16px] tablet:text-[20px]">{item.title}</p>
                    <p className="text-[14px] hidden tablet:block font-[500] mt-2 mb-5">{item.desc}</p>
                    <p className="tablet:hidden text-[14px] font-[500] mt-2 ">{item.desc2}</p>
                    <Link to="#" className="py-2 px-6 w-fit hidden tablet:block border-2 border-blue rounded-md">Go</Link>
                  </div>
                    <Link to="#" className="w-[25%] flex tablet:hidden items-center">
                      <img className="w-[44px] h-[44px] m-auto" src={rightArrow} alt=".." />
                    </Link>
                </div>
            ))}
        </div>
