...
const About = () => {
  return (
    <div id="about" className="py-16 bg-light flex flex-col w-[97%] h-fit mx-auto max-w-[1430px]">
      ...
      <p className="laptop:hidden font-[600] text:[14px] tablet:text-[16px] text-justify w-[95%] laptop:w-[650px] mx-auto">
      ...
      <p className="w-[95%] laptop:w-[650px] mt-4 mx-auto text-[16px] tablet:text-[18px] text-justify tracking-wider italic">This Project is Done by a Team of two student which had equally contributed to the success of this project</p>
    </div>
  );
};
